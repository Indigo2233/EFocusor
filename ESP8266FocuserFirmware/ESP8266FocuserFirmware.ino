...
<button class="toggle" id="tempComp">TempComp</button>
...
function setState(s){
 ...
 $('tempComp').classList.toggle('active',!!s.tempComp);
...
$('tempComp').onclick=()=>api('/api/settings',{tempComp:!state.tempComp}).then(setState);
$('saveSettings').onclick=()=>{
 const body={
  ...
  tempCoeff:Number($('tempCoeff').value)
 };
